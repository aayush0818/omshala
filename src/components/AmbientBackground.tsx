...
const AmbientBackground = () => {
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      <div
        ref={aRef}
        className="absolute -top-[15%] -left-[10%] w-[45vw] h-[45vw] rounded-full bg-brand-purple-soft/[0.06] blur-[40px] will-change-transform"
      />
      <div
        ref={bRef}
        className="absolute -bottom-[20%] -right-[10%] w-[40vw] h-[40vw] rounded-full bg-earth/[0.05] blur-[40px] will-change-transform"
      />
    </div>
  );
};
