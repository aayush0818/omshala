    ...
    <PageTransition>
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-charcoal">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-background/65 via-transparent to-background/25" />
        </div>
        ...
        <div className="container mx-auto px-6 sm:px-10 lg:px-16 relative z-10 pt-32 pb-16">
          <div className={`max-w-2xl transition-all duration-1000 [text-shadow:0_1px_24px_rgba(0,0,0,0.45)] ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
