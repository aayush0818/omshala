...
const contactMethods = [
  { icon: Mail, label: "Email", value: "omshala.official@gmail.com", href: "mailto:omshala.official@gmail.com", color: false },
  { icon: Phone, label: "WhatsApp", value: "+91 74003 61681", href: "https://wa.me/917400361681", color: false },
  { icon: InstagramColorIcon, label: "Instagram", value: "@omshala.official", href: "https://www.instagram.com/omshala.official", color: true },
];
                ...
                <Reveal key={m.label} delay={i * 0.06}>
                  ...
                  >
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full border border-foreground/10 group-hover:border-brand-purple/60 group-hover:bg-brand-purple/10 mb-6 transition-all duration-500">
                      <m.icon className={m.color ? "w-5 h-5" : "w-4 h-4 text-brand-purple"} />
                    </div>
